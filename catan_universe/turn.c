...
void first_sec_turn(){
	...
	while(count!=4){
		...
		switch(player_order)
		{
			case 0:
				//Temp message
				map_log_update(1,"'s first round.",-1);
				while(1){
					map_print(1);
					//char extra;
				...
				break;
			case 1:
				map_log_update(2,"'s first round.",-1);
				while(1){
					vi_cho = rand() % 54;
				...
				break;
			case 2:
				map_log_update(3,"'s first round.",-1);
				while(1){
					vi_cho = rand() % 54;
				...
				break;
			case 3:
				map_log_update(4,"'s first round.",-1);
				while(1){
					vi_cho = rand() % 54;
	...
	while(count!=4){
		...
		switch(player_order){
			case 0:
				map_log_update(1,"'s second round.",-1);
				while(1){
					map_print(1);
					printf("Which point you want to build Village ? (0-53): ");
					if((scanf("%d",&vi_cho)) == 0){
				...
				break;
			case 1:
				map_log_update(2,"'s second round.",-1);
				//sleep(1);
				while(1){
					vi_cho = rand() % 54;
				...
				break;
			case 2:
				map_log_update(3,"'s second round.",-1);
				while(1){
					vi_cho = rand() % 54;
				...
				break;
			case 3:
				map_log_update(4,"'s second round.",-1);
				while(1){
					vi_cho = rand() % 54;
